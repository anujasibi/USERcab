...
public class sourcescheduling extends AppCompatActivity {
    private long date;
    private DateFormat format;
    String currentDateandTime;
    private SavedAdapter savedAdapter;
    private SlidingUpPanelLayout mLayout;
    EditText editText,sources,seat;
    ...
    ImageView imagen;
    private String source_lat,source_lng,dest_lat,dest_lng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sourcescheduling);
        sessionManager = new SessionManager(this);
        dialog=new ProgressDialog(sourcescheduling.this,R.style.MyAlertDialogStyle);
...
//        };
            ...
            public void onClick(View v) {
               ...
               /* String address = editText.getText().toString();
                ...
                locationAddress.getAddressFromLocation(address,
                        getApplicationContext(), new sourcescheduling.GeocoderHandler());
                */
        ...
        sources=(EditText)findViewById(R.id.froms);

        sources.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                String address = sources.getText().toString();
        ...
        editText.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                GeocodingLocation locationAddress = new GeocodingLocation();
                locationAddress.getAddressFromLocation(address,
                        getApplicationContext(), new sourcescheduling.GeocoderHandler1());
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(sourcescheduling.this,PLACE.class));
            }
        });
...
//        }
        ...
        set_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(sourcescheduling.this, dated, ca
        ...
        set_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(sourcescheduling.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case 1:
                    ...
                    source_lat = lat;
                    source_lng = lonh;
                    Toast.makeText(sourcescheduling.this,source_lat+source_lng,Toast.LENGTH_SHORT).show();
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case 1:
                    ...
                    lat= bundle.getString("lat");
                    lonh=bundle.getString("long");
                    Log.d("destination","mm"+lat);
                    Log.d("longitude","mm"+lonh);
                    dest_lat = lat;
                    dest_lng = lonh;
                    Toast.makeText(sourcescheduling.this,dest_lat+dest_lng,Toast.LENGTH_SHORT).show();
                    //    sessionManager.setDestLat(lat);
                    //  sessionManager.setDestLong(lonh);
                    break;
                default:
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLline,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        dialog.dismiss();
                        Toast.makeText(sourcescheduling.this,response,Toast.LENGTH_LONG).show();
                        //parseData(response);
                        try {
                            ...
                            if(status.equals("200")){
                                Toast.makeText(sourcescheduling.this, ot, Toast.LENGTH_LONG).show();
                                startActivity(new Intent(sourcescheduling.this,scheduledetails.class));
                                Intent i=new Intent(sourcescheduling.this,scheduledetails.class);
                                ...
                                Toast.makeText(sourcescheduling.this, "Invalid Password."+ot, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(sourcescheduling.this,error.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
            protected Map<String,String> getParams(){
                ...
                Log.d("destlatt","mm"+dest_lat);
                params.put("dest_long",dest_lng);
                Log.d("destlatt","mm"+sessionManager.getScheduledlong());
                params.put("src_lat",source_lat);
                params.put("src_lng",source_lng);
                params.put("source",sources.getText().toString());
                params.put("destination",editText.getText().toString());
                params.put("seats",seat.getText().toString());
                return params;
            }
            @Override
    ...
    private void setupRecycler(){
        ...
        ItemClickSupport.addTo(recyclerView).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            @Override
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                Toast.makeText(sourcescheduling.this,"You clicked"+save.get(position).getName(),Toast.LENGTH_SHORT).show();
